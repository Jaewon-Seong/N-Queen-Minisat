...
void d_d(int x, int y);     //diagonal_down
void d_u(int x, int y);     //diagonal_up
...
{
    int i, j, c, q, k, n;
    printf("Enter the value of N :-");      //input the number of Queen
    scanf("%d", &n);
    N = n;
    ...
    system("./minisat coding1.txt results.txt");        //execute system command to make minisa-input file
    f = fopen("results.txt", "r");                      //N-Queen result file
